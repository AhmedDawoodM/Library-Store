...
public class BookServiceImpl implements BookService{
    ...
    private List<Book> simulateDatabaseReturnList() {
        ...
        Book book4 = new Book(4, "Prisoners", new Author(44,"Snow Shoe"), 1);
        Book book5 = new Book(5, "Java for Beginners", new Author(55,"David Adams"), 10);
        Book book6 = new Book(6, "Once Upon a Time", new Author(66,"Steve Jobs"), 1);
        Book book7 = new Book(7, "Doctors", new Author(77,"Mohamed Hussein Yakoub"), 7);
